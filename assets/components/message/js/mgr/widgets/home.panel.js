...
Cmp.panel.Home = function(config) {
    ...
    Ext.apply(config,{
        ...
        ,items: [{
            html: '<h2>'+_('message.management')+'</h2>'
            ,border: false
            ...
            ,border: true
            ,items: [{
                title: _('message.sermon')
                ,defaults: { autoHeight: true }
                ,items: [{
                    html: '<p>'+_('message.sermon_management_desc')+'</p><br />'
                    ,border: false
                },{
                    xtype: 'cmp-grid-sermon'
                    ,preventRender: true
                }]
            },{
                title: _('message.group')
                ,defaults: { autoHeight: true }
                ,items: [{
                    html: '<p>'+_('message.group_management_desc')+'</p><br />'
                    ,border: false
                },{
                    xtype: 'cmp-grid-group'
                    ,preventRender: true
                }]
            }]
        }]
